...
System-layer template files used by career-ops scripts and modes. Put user customizations in the user-layer files instead (see DATA_CONTRACT.md).
...
**Do not rename states** -- all pipeline scripts depend on these exact IDs. You can add aliases if you encounter new variants that should map to an existing state.
