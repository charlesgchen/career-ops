...
<!-- Map YOUR projects to each archetype. Example:
     ...
     | Agentic | My chatbot with HITL escalation | a base résumé section 3 | -->

| If the role is... | Emphasize about you... | Proof point sources |
|-------------------|------------------------|---------------------|
| Platform / LLMOps | Production systems builder, observability, evals | article-digest.md + a base résumé |
| Agentic / Automation | Multi-agent orchestration, HITL, reliability | article-digest.md + a base résumé |
| Technical AI PM | Product discovery, PRDs, metrics | a base résumé + article-digest.md |
| Solutions Architect | System design, integrations, enterprise-ready | article-digest.md + a base résumé |
| Forward Deployed Engineer | Fast delivery, client-facing, prototype to prod | a base résumé + article-digest.md |
| AI Transformation Lead | Change management, team enablement, adoption | a base résumé + article-digest.md |
